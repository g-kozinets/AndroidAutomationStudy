...
public class SellerInfoScreen extends SecretClosetScreen {
    ...
    private final ILabel sellerName = getElementFactory().getLabel(By.xpath("//*[@resource-id='com.zdv.secretcloset:id/toolbar']//android.widget.TextView[contains(@text, '')]"), "Seller's Name");
    private final ILabel sellerCity = getElementFactory().getLabel(By.id("com.zdv.secretcloset:id/tvItemSellerCity"), "Seller's City");
